function J=regionRGB(I,x,y,reg_maxdist)
...
reg_mean = mean(I(x,y,:)); % The mean of the segmented region
...
pixdist=0; % Distance of the region newest pixel to the regio mean1
...
while(pixdist<reg_maxdist&&reg_size<numel(I))
    ...
    for j=1:4,
        ...
        if(ins&&(J(xn,yn)==0)) 
                ...
                reg_avg = mean(I(xn,yn,:));
                
                neg_list(neg_pos,:) = [xn yn reg_avg];
